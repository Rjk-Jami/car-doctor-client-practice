...
const BookingRow = ({booking,handleDelete, handleConfirm}) => {
    const {customerName, price, bookingDate,image,serviceTitle, _id, status} =booking
        ...
        <td>
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm opacity-50">Owner: {customerName}</div>
            </div>
          </div>
        </td>
        <td>
